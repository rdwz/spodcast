...
def main():
    parser = argparse.ArgumentParser(
        prog="spodcast", description="A caching Spotify podcast to RSS proxy."
    )
    parser.add_argument(
        "-c", "--config-location", type=str, help="Specify the spodcast.json location"
    )
